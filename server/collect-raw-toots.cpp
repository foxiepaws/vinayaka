...
static set <string> get_full_words (set <string> toots)
{
	...
	vector <string> model_6 = get_words_from_toots (toots_vector, 6, 4800);
	vector <string> model_9 = get_words_from_toots (toots_vector, 9, 1600);
	vector <string> model_12 = get_words_from_toots (toots_vector, 12, 1600);
	set <string> all;
	...
	unsigned int minimum_occupancy)
{
	...
	for (auto user_to_toots: users_to_toots) {
		...
		set <string> toots = user_to_toots.second;
		vector <string> toots_vector {toots.begin (), toots.end ()};
		vector <string> model_6 = get_words_from_toots (toots_vector, 6, 2400, words_to_speakers, minimum_occupancy);
		vector <string> model_9 = get_words_from_toots (toots_vector, 9, 800, words_to_speakers, minimum_occupancy);
		vector <string> model_12 = get_words_from_toots (toots_vector, 12, 800, words_to_speakers, minimum_occupancy);
		set <string> all;
		all.insert (model_6.begin (), model_6.end ());
		all.insert (model_9.begin (), model_9.end ());
		all.insert (model_12.begin (), model_12.end ());
